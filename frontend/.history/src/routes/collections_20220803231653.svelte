<section class="text-gray-600 body-font">
    <div class="container mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        <h1 class="text-xs text-red-500 tracking-widest font-medium title-font mb-1">Librería Digital</h2>
      ...
      <div class="rounded-lg h-64 overflow-hidden">
        <img alt="content" class="object-cover object-center h-full w-full" src="https://blogthinkbig.com/wp-content/uploads/sites/4/2017/12/tablet-1632909_1920.jpg?fit=1920%2C1275">
      </div>
