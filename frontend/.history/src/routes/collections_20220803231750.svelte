<section class="text-gray-600 body-font">
    <div class="container mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        <h1 class="text-xs text-red-500 tracking-widest font-medium title-font mb-1">Librería Digital</h1>
        <h2 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Universo Jarilla</h2>
